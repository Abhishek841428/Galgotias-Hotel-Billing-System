...
def bill_button_operation():
    ...
    if ans=="yes":
        ...
        st = "\t\t\t\tGalgotias Restaurant\n\t\t\tsector-17A, Gr.Noida-U.P\n"
        st+="\n Developed BY-   Mohd Afaque , Abhishek, Yash   sem-5"
...
root.title("Welcome to Galgotias Restaurant")
...
title_label = Label(title_frame, text="Galgotias Restaurant", 
